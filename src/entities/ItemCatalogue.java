...
public class ItemCatalogue {
    ...
    private void initiateItems(){
        ...
        //Miscs
        Catalogue.add(new Misc("Gold Watch", 100, "Someone dropped this, now it's yours!", 48, 5, 3, "coin_anim_f3"));
        Catalogue.add(new Misc("Platinum Ring", 101, "Someone dropped this, now it's yours!", 72, 4, 3, "coin_anim_f1"));
        //Consumables
        Catalogue.add(new Consumables("Health Potion", 200, "Eww! It looks like blood, wonder if I should drink it!", 10, 50, 5, 3, "flask_big_red"));
        //Materials
        Catalogue.add(new Material("Iron", 300, "Valuable raw material, used for tool crafting", 24, 250, 5, 3, "coin_anim_f1"));
        Catalogue.add(new Material("Iron", 301, "Valuable raw material, used for tool crafting", 24, 250, 3, 1, "coin_anim_f1"));
        //Pickaxes
